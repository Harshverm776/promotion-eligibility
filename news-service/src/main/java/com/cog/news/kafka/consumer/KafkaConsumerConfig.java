...
public class KafkaConsumerConfig {
	...
	public ConsumerFactory<String, News> consumerFactory() {
		...
		return new DefaultKafkaConsumerFactory<String, News>(config, new StringDeserializer(), new JsonDeserializer<>(News.class));
	}

	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, News> newsListener() {
